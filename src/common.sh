...
# Release trust is intentionally incomplete until the maintainer performs the
# offline production-key ceremony. The managed-profile client fails closed
# while either value is absent; fixture tests override these shell variables
# only after sourcing the modules.
...
RUNTIME_RELEASE_PRIMARY_FINGERPRINT=""
